                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                            ...
                                            .addComponent(txtPassword, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(togglePwd, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
private boolean isValidData() throws SQLException {
    ...
    String standing = txtStanding.getText().trim();
    ...
    if (userId.isEmpty() || !isInteger(userId) || isDuplicateUserID(userId)) {
        lblUserIDError.setText(userId.isEmpty() ? "Required." : (!isInteger(userId) ? "Must be an integer." : "UserID already exists."));
    ...
    if (standing.isEmpty() || standing.length() > 20) {
        lblMajorError.setText(standing.isEmpty() ? "Required." : "Must be < 20 chars.");
        lblMajorError.setVisible(true);
        result = false;
    }

    if (major.isEmpty() || major.length() > 20) {
        lblStandingError.setText(major.isEmpty() ? "Required." : "Must be < 20 chars.");
